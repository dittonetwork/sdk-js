 ...
 */
function createWorkflowSignerBuilder(walletClient: WalletClient) {
	 ...
	 */
	const setDomain = (domain: TypedDataDomain) => {
		state.domain = domain;
		return builder;
	};
...
export { createWorkflowSignerBuilder, MERKLE_ROOT_TYPES, type WorkflowSigner };
